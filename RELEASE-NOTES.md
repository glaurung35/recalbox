...
## Version 9.2-jamma-18

- Ajout de l'overclock pour le Pi5 (START -> Options Avancés -> Overclock)
- Ajout d'une option pour passer les videos de boot (START -> Options Avancés -> Options de boot)
- Plus de popup dans retroarch
