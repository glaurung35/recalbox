...
<xsl:stylesheet version="1.1" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
   ...
   <xsl:template match="datafile|mame">
      ...
      <xsl:value-of select="'|'"/>
      <!--width du jeu ref lastmame-->
      <xsl:value-of select="'width'" /> 
      <xsl:value-of select="'|'"/>
      <!--height du jeu ref lastmame-->
      <xsl:value-of select="'height'" /> 
      <xsl:value-of select="'|'"/>
      <!--refresh du jeu ref lastmame-->
   ...
   <xsl:template match="game|machine">
      ...
      <!--width du jeu ref lastmame-->
      <xsl:variable name="lastmamewidth"> 
         <xsl:value-of select="$lastmamegame/display/@width" />
      </xsl:variable>
      <!--height du jeu ref lastmame-->
      <xsl:variable name="lastmameheight"> 
         <xsl:value-of select="$lastmamegame/display/@height" />
      </xsl:variable>
      <!--refresh du jeu ref lastmame-->
      <xsl:variable name="lastmamerefresh"> 
         <xsl:value-of select="$lastmamegame/display/@refresh" />
      </xsl:variable>
      ...
      <xsl:value-of select="'|'"/>
      <!--width du jeu ref lastmame-->
      <xsl:value-of select="$lastmamewidth" /> 
      <xsl:value-of select="'|'"/>
      <!--height du jeu ref lastmame-->
      <xsl:value-of select="$lastmameheight" /> 
      <xsl:value-of select="'|'"/>
      <!--refresh du jeu ref lastmame-->
      <xsl:value-of select="$lastmamerefresh" /> 
      <xsl:value-of select="'|'"/>
      <!--bios du jeu-->
      <xsl:value-of select="$bios" /> 
      <xsl:value-of select="'|'"/>
