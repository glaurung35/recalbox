...
define EVSIEVE_INSTALL_TARGET_CMDS
	...
	$(INSTALL) -D -m 0755 $(BR2_EXTERNAL_RECALBOX_PATH)/package/evsieve/evsieve-merge-devices \
		$(TARGET_DIR)/usr/bin/evsieve-merge-devices
	$(TARGET_STRIP) -s $(TARGET_DIR)/usr/bin/evsieve
	$(INSTALL) -D -m 0755 $(BR2_EXTERNAL_RECALBOX_PATH)/package/evsieve/evsieve-helper $(TARGET_DIR)/usr/bin/evsieve-helper
endef
