...
KF5_KCRASH_DEPENDENCIES = kf5-extra-cmake-modules qt5base qt5x11extras kf5-kwindowsystem
KF5_KCRASH_INSTALL_STAGING = YES

# Uses __atomic_fetch_add_4
ifeq ($(BR2_TOOLCHAIN_HAS_LIBATOMIC),y)
KF5_KCRASH_CONF_OPTS += -DCMAKE_EXE_LINKER_FLAGS=-latomic
endif
