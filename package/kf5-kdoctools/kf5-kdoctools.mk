...
KF5_KDOCTOOLS_DEPENDENCIES = kf5-extra-cmake-modules qt5base libxml2 libxslt perl-uri
KF5_KDOCTOOLS_INSTALL_STAGING = YES

# Uses __atomic_fetch_add_4
ifeq ($(BR2_TOOLCHAIN_HAS_LIBATOMIC),y)
KF5_KDOCTOOLS_CONF_OPTS += -DCMAKE_EXE_LINKER_FLAGS=-latomic
endif
