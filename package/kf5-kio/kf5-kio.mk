...
KF5_KIO_DEPENDENCIES = kf5-extra-cmake-modules qt5base kf5-kservice kf5-solid util-linux acl
KF5_KIO_INSTALL_STAGING = YES

# Uses __atomic_fetch_add_4
ifeq ($(BR2_TOOLCHAIN_HAS_LIBATOMIC),y)
KF5_KIO_CONF_OPTS += -DCMAKE_EXE_LINKER_FLAGS=-latomic -DKIOCORE_ONLY=ON -BUILD_DESIGNERPLUGIN=OFF
endif
