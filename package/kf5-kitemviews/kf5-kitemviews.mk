...
KF5_KITEMVIEWS_DEPENDENCIES = kf5-extra-cmake-modules qt5base
KF5_KITEMVIEWS_INSTALL_STAGING = YES

# Uses __atomic_fetch_add_4
ifeq ($(BR2_TOOLCHAIN_HAS_LIBATOMIC),y)
KF5_KITEMVIEWS_CONF_OPTS += -DCMAKE_EXE_LINKER_FLAGS=-latomic -DBUILD_DESIGNERPLUGIN=OFF
endif
