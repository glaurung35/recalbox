...
KODI_SCRIPT_MODULE_PYTHON_TWITCH_SOURCE = $(KODI_SCRIPT_MODULE_PYTHON_TWITCH_PLUGIN_NAME)-$(KODI_SCRIPT_MODULE_PYTHON_TWITCH_VERSION)+$(KODI_SCRIPT_MODULE_PYTHON_TWITCH_RELEASE).1.zip
KODI_SCRIPT_MODULE_PYTHON_TWITCH_SITE = https://github.com/anxdpanic/$(KODI_SCRIPT_MODULE_PYTHON_TWITCH_PLUGIN_NAME)/releases/download/v$(KODI_SCRIPT_MODULE_PYTHON_TWITCH_VERSION)
