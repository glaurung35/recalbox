...
RECALBOX_SYSTEM_FIRMWAREDIR = boot-data

ifeq ($(BR2_PACKAGE_RECALBOX_EGL_NO_X11),y)
RECALBOX_SYSTEM_TARGET_CFLAGS += -DEGL_NO_X11
RECALBOX_SYSTEM_TARGET_CXXFLAGS += -DEGL_NO_X11
endif
...
RECALBOX_SYSTEM_TARGET_DEPENDENCIES += librga
else ifeq ($(BR2_PACKAGE_RECALBOX_TARGET_RG351V),y)
RECALBOX_SYSTEM_PLATFORM=rg351v
RECALBOX_SYSTEM_RECALBOX_CONF=rg351v
RECALBOX_SYSTEM_TARGET_DEPENDENCIES += librga
else ifeq ($(BR2_PACKAGE_RECALBOX_TARGET_RG353X),y)
RECALBOX_SYSTEM_PLATFORM=rg353x
RECALBOX_SYSTEM_RECALBOX_CONF=rg353x
