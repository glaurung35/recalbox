...
#
# RETROARCH_LIBRETRO_BOARD_SHORT skips bit width from board (rpi5_64 => rpi5)
ifeq ($(RECALBOX_SYSTEM_PLATFORM),rpizero2)
RETROARCH_LIBRETRO_BOARD=rpi3
RETROARCH_LIBRETRO_BOARD_SHORT=rpi3
...
RETROARCH_LIBRETRO_BOARD=$(RECALBOX_SYSTEM_PLATFORM)
RETROARCH_LIBRETRO_BOARD_SHORT=rpi4
else ifeq ($(RECALBOX_SYSTEM_PLATFORM),rpi4_64)
RETROARCH_LIBRETRO_BOARD=$(RECALBOX_SYSTEM_PLATFORM)
RETROARCH_LIBRETRO_BOARD_SHORT=rpi4
else ifeq ($(RECALBOX_SYSTEM_PLATFORM),rpi5_64)
RETROARCH_LIBRETRO_BOARD=$(RECALBOX_SYSTEM_PLATFORM)
RETROARCH_LIBRETRO_BOARD_SHORT=rpi5
else
RETROARCH_LIBRETRO_BOARD=$(RETROARCH_LIBRETRO_PLATFORM)
RETROARCH_LIBRETRO_BOARD_SHORT=$(RETROARCH_LIBRETRO_PLATFORM)
endif
