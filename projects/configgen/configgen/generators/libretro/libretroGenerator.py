...
class LibretroGenerator(Generator):
    ...
    def configureFlycastWide(system: Emulator) -> Dict[str, Any]:
        return {"flycast_widescreen_hack": '"On"' if system.WideScreenMode else '"Off"'}
    ...
    def createHDWidescreenConfig(system: Emulator) -> (Dict[str, Any], Dict[str, Any], str):
        ...
        systemsToWideScreenOrHdCore = {"snes": "bsneshd", "megadrive": "genesisplusgxwide", "dreamcast": "flycast",
                                       "naomi": "flycast", "atomiswave": "flycast", "playstation": "pcsx_rearmed",
                                       "saturn": "yabasanshiro"}
        ...
        hdCoreToCoreConfig = {
            "flycast":
                [
                    {"flycast_internal_resolution": '"1024x768"', "flycast_cable_type": '"VGA (RGB)"'},
                    {"flycast_internal_resolution": '"640x480"', "flycast_cable_type": '"VGA (RGB)"'}
                ],
            "pcsx_rearmed":
                [
