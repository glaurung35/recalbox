...
extern const uint16_t help__piboy_xrs_menu_png_size;
extern const uint8_t help__piboy_xrs_menu_png_data[];
...
extern const uint16_t regions__ame_svg_size;
extern const uint8_t regions__ame_svg_data[];

extern const uint16_t regions__asi_svg_size;
extern const uint8_t regions__asi_svg_data[];

extern const uint16_t regions__au_svg_size;
extern const uint8_t regions__au_svg_data[];

extern const uint16_t regions__be_svg_size;
extern const uint8_t regions__be_svg_data[];

extern const uint16_t regions__br_svg_size;
extern const uint8_t regions__br_svg_data[];

extern const uint16_t regions__bu_svg_size;
extern const uint8_t regions__bu_svg_data[];

extern const uint16_t regions__ca_svg_size;
extern const uint8_t regions__ca_svg_data[];

extern const uint16_t regions__cl_svg_size;
extern const uint8_t regions__cl_svg_data[];

extern const uint16_t regions__cn_svg_size;
extern const uint8_t regions__cn_svg_data[];
...
extern const uint16_t regions__dk_svg_size;
extern const uint8_t regions__dk_svg_data[];

extern const uint16_t regions__es_svg_size;
extern const uint8_t regions__es_svg_data[];

extern const uint16_t regions__eu_svg_size;
extern const uint8_t regions__eu_svg_data[];

extern const uint16_t regions__fi_svg_size;
extern const uint8_t regions__fi_svg_data[];

extern const uint16_t regions__fr_svg_size;
extern const uint8_t regions__fr_svg_data[];

extern const uint16_t regions__gr_svg_size;
extern const uint8_t regions__gr_svg_data[];

extern const uint16_t regions__hk_svg_size;
extern const uint8_t regions__hk_svg_data[];

extern const uint16_t regions__hu_svg_size;
extern const uint8_t regions__hu_svg_data[];

extern const uint16_t regions__il_svg_size;
extern const uint8_t regions__il_svg_data[];

extern const uint16_t regions__it_svg_size;
extern const uint8_t regions__it_svg_data[];

extern const uint16_t regions__jp_svg_size;
extern const uint8_t regions__jp_svg_data[];

extern const uint16_t regions__kr_svg_size;
extern const uint8_t regions__kr_svg_data[];

extern const uint16_t regions__nl_svg_size;
extern const uint8_t regions__nl_svg_data[];

extern const uint16_t regions__no_svg_size;
extern const uint8_t regions__no_svg_data[];

extern const uint16_t regions__nz_svg_size;
extern const uint8_t regions__nz_svg_data[];

extern const uint16_t regions__pl_svg_size;
extern const uint8_t regions__pl_svg_data[];

extern const uint16_t regions__pt_svg_size;
extern const uint8_t regions__pt_svg_data[];

extern const uint16_t regions__ru_svg_size;
extern const uint8_t regions__ru_svg_data[];

extern const uint16_t regions__sw_svg_size;
extern const uint8_t regions__sw_svg_data[];
...
extern const uint16_t regions__uk_svg_size;
extern const uint8_t regions__uk_svg_data[];

extern const uint16_t regions__us_svg_size;
extern const uint8_t regions__us_svg_data[];

extern const uint16_t regions__wor_svg_size;
extern const uint8_t regions__wor_svg_data[];
...
typedef const HashMap<const String, const Res2hEntry*> res2hMapType;
