...
class Bios
{
  ...
  public:
     ...
     * @return True if
     */
    [[nodiscard]] bool IsValid() const { return !mPathx[0].IsEmpty() && !mCores.empty() && !mHashes.empty(); }
    ...
    //! Bios file path
    [[nodiscard]] const Path& Filepath() const { return mPathx[0]; }
