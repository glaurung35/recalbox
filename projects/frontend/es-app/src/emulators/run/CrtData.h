...
class CrtData
{
  public:
    ...
    void ConfigureHighResolution(bool highRez, SystemData& system)
    {
      ...
      mScanlines = (highRez
          && !system.Descriptor().CrtHighResolution() &&
    ...
    {
      if (!mHighResolutionConfigured)
        ConfigureHighResolution(system.Descriptor().CrtHighResolution() || Board::Instance().CrtBoard().GetHorizontalFrequency() == ICrtInterface::HorizontalFrequency::KHz31, system);
    }
