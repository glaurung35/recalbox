  ...
  switch(type)
  {
    case ItemType::Game:
    {
      static const MetadataFieldDescriptor sGameMetadataDescriptors[] =
      {
        ...
        MetadataFieldDescriptor("alias"      , ""     , _("Alias")       , _("enter game alias")            , MetadataFieldDescriptor::DataType::String , MetadataFieldDescriptor::EditableType::Text   , &MetadataDescriptor::IsDefaultAlias          , &MetadataDescriptor::AliasAsString       , &MetadataDescriptor::SetAlias                , false, true),
        MetadataFieldDescriptor("families"   , ""     , _("Families")    , _("enter game families")         , MetadataFieldDescriptor::DataType::String , MetadataFieldDescriptor::EditableType::Text   , &MetadataDescriptor::IsDefaultFamilies       , &MetadataDescriptor::FamiliesAsString    , &MetadataDescriptor::SetFamilies             , false, true),
        MetadataFieldDescriptor("rating"     , "0.0"  , _("Rating")      , _("enter rating")                , MetadataFieldDescriptor::DataType::Rating , MetadataFieldDescriptor::EditableType::Rating , &MetadataDescriptor::IsDefaultRating         , &MetadataDescriptor::RatingAsString      , &MetadataDescriptor::SetRatingAsString       , false, true),
        MetadataFieldDescriptor("favorite"   , "false", _("Favorite")    , _("enter favorite")              , MetadataFieldDescriptor::DataType::Bool   , MetadataFieldDescriptor::EditableType::Switch , &MetadataDescriptor::IsDefaultFavorite       , &MetadataDescriptor::FavoriteAsString    , &MetadataDescriptor::SetFavoriteAsString     , false, true),
        ...
        MetadataFieldDescriptor("emulator"   , ""     , _("Emulator")    , _("enter emulator")              , MetadataFieldDescriptor::DataType::List   , MetadataFieldDescriptor::EditableType::List   , &MetadataDescriptor::IsDefaultEmulator       , &MetadataDescriptor::EmulatorAsString    , &MetadataDescriptor::SetEmulator             , false, true),
        MetadataFieldDescriptor("core"       , ""     , _("Core")        , _("enter core")                  , MetadataFieldDescriptor::DataType::List   , MetadataFieldDescriptor::EditableType::List   , &MetadataDescriptor::IsDefaultCore           , &MetadataDescriptor::CoreAsString        , &MetadataDescriptor::SetCore                 , false, true),
        MetadataFieldDescriptor("ratio"      , "auto" , _("Ratio")       , _("enter ratio")                 , MetadataFieldDescriptor::DataType::List   , MetadataFieldDescriptor::EditableType::List   , &MetadataDescriptor::IsDefaultRatio          , &MetadataDescriptor::RatioAsString       , &MetadataDescriptor::SetRatio                , false, true),
        ...
        MetadataFieldDescriptor("video"      , ""     , _("Video")       , _("enter path to video")         , MetadataFieldDescriptor::DataType::Path   , MetadataFieldDescriptor::EditableType::Text   , &MetadataDescriptor::IsDefaultVideo          , &MetadataDescriptor::VideoAsString       , &MetadataDescriptor::SetVideoPathAsString    , false, false),
        MetadataFieldDescriptor("releasedate", ""     , _("Release date"), _("enter release date")          , MetadataFieldDescriptor::DataType::Date   , MetadataFieldDescriptor::EditableType::Date   , &MetadataDescriptor::IsDefaultReleaseDateEpoc, &MetadataDescriptor::ReleaseDateAsString , &MetadataDescriptor::SetReleaseDateAsString  , false, false),
        MetadataFieldDescriptor("developer"  , ""     , _("Developer")   , _("enter game developer")        , MetadataFieldDescriptor::DataType::String , MetadataFieldDescriptor::EditableType::Text   , &MetadataDescriptor::IsDefaultDeveloper      , &MetadataDescriptor::DeveloperAsString   , &MetadataDescriptor::SetDeveloper            , false, false),
        MetadataFieldDescriptor("publisher"  , ""     , _("Publisher")   , _("enter game publisher")        , MetadataFieldDescriptor::DataType::String , MetadataFieldDescriptor::EditableType::Text   , &MetadataDescriptor::IsDefaultPublisher      , &MetadataDescriptor::PublisherAsString   , &MetadataDescriptor::SetPublisher            , false, false),
        MetadataFieldDescriptor("genre"      , ""     , _("Genre")       , _("enter game genre")            , MetadataFieldDescriptor::DataType::Int    , MetadataFieldDescriptor::EditableType::Text   , &MetadataDescriptor::IsDefaultGenre          , &MetadataDescriptor::GenreAsString       , &MetadataDescriptor::SetGenre                , false, false),
        MetadataFieldDescriptor("genreid"    , ""     , _("Genre ID")    , _("enter game genre id")         , MetadataFieldDescriptor::DataType::Int    , MetadataFieldDescriptor::EditableType::List   , &MetadataDescriptor::IsDefaultGenreId        , &MetadataDescriptor::GenreIdAsString     , &MetadataDescriptor::SetGenreIdAsString      , false, false),
        MetadataFieldDescriptor("adult"      , ""     , _("Adult")       , _("enter adult state")           , MetadataFieldDescriptor::DataType::Bool   , MetadataFieldDescriptor::EditableType::Switch , &MetadataDescriptor::IsDefaultAdult          , &MetadataDescriptor::AdultAsString       , &MetadataDescriptor::SetAdultAsString        , false, false),
        MetadataFieldDescriptor("players"    , "1"    , _("Players")     , _("enter number of players")     , MetadataFieldDescriptor::DataType::Range  , MetadataFieldDescriptor::EditableType::Text   , &MetadataDescriptor::IsDefaultPlayerRange    , &MetadataDescriptor::PlayersAsString     , &MetadataDescriptor::SetPlayersAsString      , false, false),
        MetadataFieldDescriptor("region"     , ""     , _("Region")      , _("enter region")                , MetadataFieldDescriptor::DataType::String , MetadataFieldDescriptor::EditableType::Text   , &MetadataDescriptor::IsDefaultRegion         , &MetadataDescriptor::RegionAsString      , &MetadataDescriptor::SetRegionAsString       , false, false),
        MetadataFieldDescriptor("playcount"  , "0"    , _("Play count")  , _("enter number of times played"), MetadataFieldDescriptor::DataType::Int    , MetadataFieldDescriptor::EditableType::None   , &MetadataDescriptor::IsDefaultPlayCount      , &MetadataDescriptor::PlayCountAsString   , &MetadataDescriptor::SetPlayCountAsString    , true , false),
        MetadataFieldDescriptor("lastplayed" , "0"    , _("Last played") , _("enter last played date")      , MetadataFieldDescriptor::DataType::Date   , MetadataFieldDescriptor::EditableType::None   , &MetadataDescriptor::IsDefaultLastPlayedEpoc , &MetadataDescriptor::LastPlayedAsString  , &MetadataDescriptor::SetLastPlayedAsString   , true , false),
        MetadataFieldDescriptor("hash"       , "0"    , _("Rom Crc32")   , _("enter rom crc32")             , MetadataFieldDescriptor::DataType::Crc32  , MetadataFieldDescriptor::EditableType::None   , &MetadataDescriptor::IsDefaultRomCrc32       , &MetadataDescriptor::RomCrc32AsString    , &MetadataDescriptor::SetRomCrc32AsString     , true , false),
        MetadataFieldDescriptor("lastPatch"  , ""     , _("Last Patch")  , _("enter patch")                 , MetadataFieldDescriptor::DataType::Path   , MetadataFieldDescriptor::EditableType::None   , &MetadataDescriptor::IsDefaultLastPath       , &MetadataDescriptor::LastPatchAsString   , &MetadataDescriptor::SetLastPatchAsString    , true , false),
        MetadataFieldDescriptor("rotation"   , "None" , _("Rotation")    , _("enter rotation")              , MetadataFieldDescriptor::DataType::Int    , MetadataFieldDescriptor::EditableType::Switch , &MetadataDescriptor::IsDefaultRotation       , &MetadataDescriptor::RotationAsString    , &MetadataDescriptor::SetRotationAsString     , false, false),
      };
...
void MetadataDescriptor::CleanupHolders()
{
  ...
  LOG(LogDebug) << "[MetadataDescriptor] Name storage: "        << sAliasHolder.StorageSize()          << " - object count: " << sAliasHolder.ObjectCount()       ;
