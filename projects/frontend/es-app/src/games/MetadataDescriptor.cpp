  ...
  switch(type)
  {
    case ItemType::Game:
    {
      static const MetadataFieldDescriptor sGameMetadataDescriptors[] =
      {
        ...
        MetadataFieldDescriptor("family"     , DefaultValueEmpty    , _("Family")       ,_("enter game family")           , MetadataFieldDescriptor::DataType::String , MetadataFieldDescriptor::EditableType::Text   , &MetadataDescriptor::IsDefaultFamily         , &MetadataDescriptor::FamilyAsString      , &MetadataDescriptor::SetFamily               , false, true),
        MetadataFieldDescriptor("family2"    , DefaultValueEmpty    , _("Family2")     ,_("enter game family2")           , MetadataFieldDescriptor::DataType::String , MetadataFieldDescriptor::EditableType::Text   , &MetadataDescriptor::IsDefaultFamily2        , &MetadataDescriptor::Family2AsString     , &MetadataDescriptor::SetFamily2              , false, true),
