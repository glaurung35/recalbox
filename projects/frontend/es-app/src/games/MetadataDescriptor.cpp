  ...
  switch(type)
  {
    case ItemType::Game:
    {
      static const MetadataFieldDescriptor sGameMetadataDescriptors[] =
      {
        ...
        MetadataFieldDescriptor("families"   , DefaultValueEmpty    , _("Families")    ,_("enter game families")          , MetadataFieldDescriptor::DataType::String , MetadataFieldDescriptor::EditableType::Text   , &MetadataDescriptor::IsDefaultFamilies       , &MetadataDescriptor::FamiliesAsString    , &MetadataDescriptor::SetFamilies             , false, true),
