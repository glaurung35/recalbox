    ...
    mShowAllSystems(false)
{
  ...
  mDetailHashMustMatchLabel = std::make_shared<TextScrollComponent>(window, "", menuTheme.SmallText().font, menuTheme.SmallText().color, TextAlignment::Right);
  ...
  mDetailFileFoundLabel = std::make_shared<TextScrollComponent>(window, "", menuTheme.SmallText().font, menuTheme.SmallText().color, TextAlignment::Right);
  mDetailFileFoundValue = std::make_shared<TextComponent>(window, "", mBoldCondensed, menuTheme.SmallText().color, TextAlignment::Left);
  mDetailHashIsMatchingLabel = std::make_shared<TextScrollComponent>(window, "", menuTheme.SmallText().font, menuTheme.SmallText().color, TextAlignment::Right);
  ...
  mDetailText2Label = std::make_shared<TextScrollComponent>(window, "", menuTheme.SmallText().font, menuTheme.SmallText().color, TextAlignment::Left);
