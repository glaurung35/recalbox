  ...
  , mSystemManager(systemManager)
{
  ...
  // License
  AddSubMenu(_("OPEN-SOURCE LICENSE"), MenuThemeData::MenuIcons::Type::License, (int)Components::License, _(MENUMESSAGE_LICENSE_HELP_MSG));

  // Quit
  AddSubMenu(_("QUIT"), MenuThemeData::MenuIcons::Type::Quit, (int)Components::Quit, _(MENUMESSAGE_QUIT_HELP_MSG));
...
void GuiMenu::SubMenuSelected(int id)
{
  switch((Components)id)
  {
    ...
    case Components::RecalboxRGBDual: mWindow.pushGui(new GuiMenuCRT(mWindow, mSystemManager, Board::Instance().CrtBoard().GetCrtAdapter() == CrtAdapterType::RGBJamma ? _("JAMMA SETTINGS") : _("CRT SETTINGS"))); break;
