...
void MenuCRT::BuildMenuItems()
{
  ...
  // Superrez multiplier
  AddList<String>(_("V2 - SUPERREZ MULTIPLIER"), (int)Components::SuperRez, this, GetSuperRezEntries(), CrtConf::Instance().GetSystemCRTSuperrez(), _(MENUMESSAGE_ADVANCED_CRT_SUPERREZ));
