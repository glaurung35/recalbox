  ...
  , mSystemManager(systemManager)
{
  ...
  AddSubMenu(_("VIRTUAL SYSTEMS PER GENRE"), (int)Components::VirtualPerGenre, this, _(MENUMESSAGE_ADVANCED_VIRTUALGENRESYSTEMS_HELP_MSG));
}

void MenuVirtualSystems::SubMenuSelected(int id)
{
  if ((Components)id == Components::VirtualPerGenre)
    mWindow.pushGui(new MenuVirtualSystemPerGenre(mWindow, mSystemManager));
}

void MenuVirtualSystems::MenuSwitchChanged(int id, bool& status)
{
