...
#define BTN_PER_PLAYER 8
static const unsigned int buttons_codes[BTN_PER_PLAYER+1] = {
    BTN_B, BTN_Y, BTN_X, BTN_TR, BTN_TL, BTN_START, BTN_SELECT, BTN_A, BTN_MODE
};
