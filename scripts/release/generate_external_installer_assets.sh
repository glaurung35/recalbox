...
function generateNoobsAssets {
  ...
  for arch in rpi1 rpi3 rpi4_64 rpi5_64; do
...
function generateRaspberryPiImagerAssets {
  ...
  for arch in rpi1 rpi3 rpi4_64 rpi5_64 rpizero2legacy rpizero2; do
  ...
  | sed -e "s|{{version}}|${metadata[version]}|" \
        ...
        -e "s|{{rpi4_64ExtractSize}}|${metadata[rpi4_64ExtractSize]}|" \
        -e "s|{{rpi5_64ExtractSize}}|${metadata[rpi5_64ExtractSize]}|" \
        ...
        -e "s|{{rpi4_64ExtractSha256}}|${metadata[rpi4_64ExtractSha256]}|" \
        -e "s|{{rpi5_64ExtractSha256}}|${metadata[rpi5_64ExtractSha256]}|" \
        ...
        -e "s|{{rpi4_64ImageDownloadSize}}|${metadata[rpi4_64ImageDownloadSize]}|" \
        -e "s|{{rpi5_64ImageDownloadSize}}|${metadata[rpi5_64ImageDownloadSize]}|" \
        ...
        -e "s|{{rpi4_64ImageDownloadSha256}}|${metadata[rpi4_64ImageDownloadSha256]}|" \
        -e "s|{{rpi5_64ImageDownloadSha256}}|${metadata[rpi5_64ImageDownloadSha256]}|" \
